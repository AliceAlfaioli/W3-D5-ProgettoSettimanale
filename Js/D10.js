...
console.log(deleteOne("Esercizio", false));
...
isThisAnEmail("email@alice.com");
isThisAnEmail("alice.com");
...
function whatDayIsIt() {
  ...
  const days = ["Domenica", "Lunedi", "Martedi", "Mercoledi", "Giovedi", "Venerdi", "Saabto"];
...
function isTodayMyBirthday() {
  ...
  const birthday = new Date("1993-06-05");
...

{
  ...
  let result = onlyInLastMillennium(movies);
...
*/
{
  ...
  const sumAllTheYears = (arr) =>
    arr.reduce((accumulator, currentValue) => accumulator + parseInt(currentValue.Year), 0);
...
if (elemento) {
  ...
  console.log("Nessun elemento con id 'elemento' trovato");
}
